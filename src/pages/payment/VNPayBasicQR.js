// src/pages/payment/VNPayBasicQR.js
import React, { useState, useEffect } from "react";

// Chúng ta sẽ tách riêng phần QR vào 1 component để dễ dùng lại
export default function VNPayBasicQR({ onDone }) {
    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          Dùng app VNPay hoặc app ngân hàng hỗ trợ QR để quét mã.
        </p>
      </div>
      ...
      <div className="text-center mb-6">
        ...
        <div className="flex items-center justify-center space-x-2">
          <div className="flex items-center bg-gradient-to-r from-red-500 to-red-600 text-white px-3 py-1 rounded-full">
            <svg
              className="w-4 h-4 mr-1"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path d="M3 4a1 1 0... (…) z" /> {/* icon VNPAY */}
            </svg>
      ...
      <div className="bg-blue-50 rounded-xl p-4 mb-6 text-sm text-gray-700">
        <ol className="list-decimal list-inside space-y-2">
          <li>Mở app VNPay hoặc app ngân hàng hỗ trợ QR </li>
      ...
      <div className="bg-gray-100 rounded-xl p-3 mb-4 text-center">
        <div className="flex items-center justify-center mb-1">
          ...
          <span className="text-sm font-medium text-gray-600">Thời gian còn:</span>
        </div>
